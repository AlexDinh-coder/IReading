...
public class BookByCategoryAdapter extends RecyclerView.Adapter<BookByCategoryAdapter.ItemHolder> {
    ...
    @NonNull
    @Override
    public BookByCategoryAdapter.ItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.item_book_in_detail , parent , false);
        return new BookByCategoryAdapter.ItemHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BookByCategoryAdapter.ItemHolder holder, int position) {
